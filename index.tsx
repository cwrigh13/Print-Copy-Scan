...
const translations = {
    'en': {
        ...
        final_photocopying_ok: "You have enough credit. Please proceed to any photocopier and log in with your card.",
    ...
    'zh-CN': {
        ...
        final_photocopying_ok: "您的信用额度足够。请到任何一台复印机并用您的卡登录。",
    ...
    'zh-HK': {
        ...
        final_photocopying_ok: "您的信用額度足夠。請到任何一台影印機並用您的卡登錄。",
    ...
    'ne': {
        ...
        final_photocopying_ok: "तपाईंसँग पर्याप्त क्रेडिट छ। कृपया कुनै पनि फोटोकपी मेसिनमा जानुहोस् र आफ्नो कार्डबाट लग इन गर्नुहोस्।",
    ...
    'it': {
        ...
        final_photocopying_ok: "Hai abbastanza credito. Per favore, procedi a una qualsiasi fotocopiatrice e accedi con la tua tessera.",
    ...
    'el': {
        ...
        final_photocopying_ok: "Έχετε αρκετή πίστωση. Παρακαλώ προχωρήστε σε οποιοδήποτε φωτοαντιγραφικό μηχάνημα και συνδεθείτε με την κάρτα σας.",

...
const unsurePagesBtn = document.getElementById('unsure-pages');
const priceModal = document.getElementById('price-modal');
const priceHelpIcon = document.getElementById('price-help-icon');
...
const costConfirmationTitleEl = document.getElementById('cost-confirmation-title');
const costDisplayEl = document.getElementById('cost-display');
const pagesTitleEl = document.getElementById('pages-title');
const scanPriceModal = document.getElementById('scan-price-modal');
const scanHelpIcon = document.getElementById('scan-help-icon');
...
function showStep(stepId, isBack = false) {
    ...
    const currentLangEl = document.querySelector('.lang-btn.active');
